<?php 
  ...
  if(isset($_POST["register"])) {
    ...
    $result = mysqli_query($koneksi, "SELECT email FROM user_angga WHERE email = '$email'");    

    if(mysqli_num_rows(($result)) !== 1 && $password == $konfirmasi_password) {
      mysqli_query($koneksi, "INSERT INTO user_angga VALUES ('', '$nama', '$email', '$password', '$no_hp')");
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          <div class="form-width">
            ...
            <p class="mt-3">Anda sudah punya akun? <a href="Login-angga.php">Login</a></p>
          </div>
        </div>
      </div>
    </div>
