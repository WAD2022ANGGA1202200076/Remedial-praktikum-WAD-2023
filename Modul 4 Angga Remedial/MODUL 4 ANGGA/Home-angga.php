<?php
  ...
  if(isset($_SESSION["login"])) {
    ...
    $hasil_login = mysqli_query($koneksi, "SELECT * FROM user_angga WHERE email = '$email'");
    ...
    <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"]) ? $_COOKIE["warna_navbar"] : "info"; ?>">
        <div class="container py-2">
          <?php if(isset($_SESSION["login"])) { ?>
            ...
            <div class="d-flex">
                <a href="Add-angga.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"]) ? $_COOKIE["warna_navbar"] : "info"; ?>" role="button">Add Car</a>
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"]) ? $_COOKIE["warna_navbar"] : "info"; ?>" href="Profile-angga.php">Profile</a></li>
          ...
          <?php } else { ?>
            <div class="navbar-nav w-100 d-flex justify-content-between">
              <a class="nav-link active" aria-current="page" href="#">Home</a>
              <a class="nav-link" href="Login-angga.php">Login</a>
            </div>
          <?php } ?>
        </div>
      </nav>
      ...
      <div class="container d-flex align-content-center home">
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam quas eius dicta, minima ullam odit incidunt! Nisi et accusamus vero ad nihil sapiente, eligendi, eius commodi neque quos adipisci ex?</p>
            <a class="btn btn-primary" href="<?= isset($_SESSION["login"]) ? "ListCar-angga.php" : "Login-angga.php"; ?>" role="button">MyCar</a>
            <div class="d-flex align-items-center position-relative" style="top: 60px;">
              ...
              <span class="ms-5 text-muted">Stevanus Dewangga_1202200076</span>
            </div>
          </div>
          <div class="col-md-6">
