<?php 
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM showroom_angga_table");
    $rows = [];

    if(mysqli_num_rows($result) == 0) {
        header("Location: Add-angga.php");
        exit;
    }
    ...
    if(isset($_SESSION["login"])) {
        ...
        header("Location: Login-angga.php");
        exit;
    }
    ...
    <body>
        ...
        <div class="container">
            <div class="mt-4">
                ...
                <p>List Show Room ANGGA - 1202200076</p>
            </div>
            <div class="row mt-5">
                ...
                <div class="col-lg-5 mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                        <a href="Detail-angga.php?id=<?= $mobil["id_mobil"]; ?>" class="btn btn-primary rounded-5 px-4 me-3 button" role="button">Detail</a>
