<?php
    ...
    $id = $_POST["id_mobil"];
    $query = "SELECT * FROM showroom_angga_table WHERE id_mobil = $id";
    ...
    if(isset($_POST["simpan"])) {
        edit($_POST);
        header(("Location: ListCar-angga.php?crud=edit"));
    }
?>
                ...
                <div class="col-md-7">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="foto_mobil" type="file" id="foto_mobil" value="<?= $data["foto_mobil"]; ?>">
                        </div>
                        <div class="mb-3">
