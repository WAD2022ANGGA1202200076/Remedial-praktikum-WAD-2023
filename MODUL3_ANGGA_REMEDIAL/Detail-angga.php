            ...
            <div class="row">
                ...
                <form class="" action="" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input type="text" class = "form-control" name="fotomobil" id="fotomobil" value="<?php echo $fotomobil?>">
                    </div>

                    <div class="mb-3 ">
                        <label class="mb-3" <?php echo $status?>>Status Pembayaran</label><br>
                    ...
                    <div class="mb-3">
                    <a href="Edit-angga.php?op=edit&id=<?php echo $id_mobil?>" class="btn btn-primary">Edit</a>
                    </div>
                </div>
                </form>
